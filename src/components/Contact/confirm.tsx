...
const Confirm = () => {
  return (
    <>
      <section className="relative z-10 pb-16 pt-0 md:pb-20 lg:pb-28 lg:pt-[20px]">
            ...
            <div className="w-full px-4">
              <div className="mx-auto max-w-[530px] text-center">
                ...
                <p className="mb-10 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed">
                  ...
                  support ticket and will promptly review your inquiry. Our team
                  is working diligently to address your request.
                </p>

                <Link href="/" className="rounded-md bg-primary px-8 py-3 text-base font-bold text-white shadow-signUp duration-300 hover:bg-white hover:text-primary md:px-9 lg:px-8 xl:px-9">
                  Back to Homepage
                </Link>
              </div>
            </div>
